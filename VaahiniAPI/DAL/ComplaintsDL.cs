...
namespace VaahiniAPI.DAL
{
    public class ComplaintsDL
    {
        ...
        public int insert_driverComplaints(ComplaintsModel objComplaintsModel)
        {
            try
            {
        ...
        public int insert_vehicleComplaints(ComplaintsModel objComplaintsModel)
        {
            try
            {
                return Execution.ExecuteNonQuery_with_result("sp_complaints", new SqlParameter[]
